...
BEGIN
  ...
  SELECT DATEFROMPARTS(DATEPART(YEAR, @BeginDate), 1,1) AS LeftBoundYear,
         EOMONTH(DATEFROMPARTS(DATEPART(YEAR, @BeginDate), 12,1)) AS RightBoundYear,
         DATEFROMPARTS(DATEPART(YEAR, @BeginDate), DATEPART(QUARTER, @BeginDate) * 3 - 2, 1) AS LeftBoundQuarter,
         EOMONTH(DATEFROMPARTS(DATEPART(YEAR, @BeginDate), DATEPART(QUARTER, @BeginDate) * 3, 1)) AS RightBoundQuarter,
         DATEFROMPARTS(DATEPART(YEAR, @BeginDate), DATEPART(MONTH, @BeginDate),1) AS LeftBoundMonth,
         EOMONTH(DATEFROMPARTS(DATEPART(YEAR, @BeginDate), DATEPART(MONTH, @BeginDate),1)) AS RightBoundMonth)
  , end_bounds AS (
  SELECT DATEFROMPARTS(DATEPART(YEAR, @EndDate), 1,1) AS LeftBoundYear,
         EOMONTH(DATEFROMPARTS(DATEPART(YEAR, @EndDate), 12,1)) AS RightBoundYear,
         DATEFROMPARTS(DATEPART(YEAR, @EndDate), DATEPART(QUARTER, @EndDate) * 3 - 2, 1) AS LeftBoundQuarter,
         EOMONTH(DATEFROMPARTS(DATEPART(YEAR, @EndDate), DATEPART(QUARTER, @EndDate) * 3, 1)) AS RightBoundQuarter,
         DATEFROMPARTS(DATEPART(YEAR, @EndDate), DATEPART(MONTH, @EndDate),1) AS LeftBoundMonth,
         EOMONTH(DATEFROMPARTS(DATEPART(YEAR, @EndDate), DATEPART(MONTH, @EndDate),1)) AS RightBoundMonth)
  , output_text AS (
